...
Version: 3.1 (Fixed Thread Handling)
"""
thread_id = "conv_123"  # Simple ID for testing
...
class EducationAssistant:
    ...
    def _build_workflow(self):
        ...
        # Configure checkpointer with thread_id as configurable
...
# =========================================================================
# Example Usage with Proper Thread Handling
# =========================================================================
if __name__ == "__main__":
    ...
    print(f"Starting new conversation (Thread ID: {thread_id[:8]}...)")
    ...
    for query in queries:
        ...
        # Process query with thread context
    ...
    # Test memory recall within the same thread
    ...
    # Test new thread isolation
    new_thread_id = str(uuid.uuid4())
    print(f"\nStarting new conversation (Thread ID: {new_thread_id[:8]}...)")
    fresh_test = assistant.graph.invoke(
        {"query": "What did we discuss earlier?", "history": [], "thread_id": new_thread_id},
        {"configurable": {"thread_id": new_thread_id}}
    )
    print(f"New Thread Bot: {fresh_test['response']}")